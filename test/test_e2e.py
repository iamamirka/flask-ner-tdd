...
class E2ETests(unittest.TestCase):
    ...
    def setUp(self):
        # I have chromedriver in PATH that's why I don't need to pass path to chromedriver as an argument
    ...
    def test_page_has_ner_table(self):
        input_element = self._find("input-text")
        submit_button = self._find("find-button")
        input_element.send_keys('France and Germany share border in Europe')
        submit_button.click()
    ...
    def _find(self, val):
        return self.driver.find_element(By.CSS_SELECTOR, f'[data-tid="{val}"]')